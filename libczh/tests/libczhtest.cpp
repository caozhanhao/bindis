...
== nullptr);
auto &node = *nodeptr;
EXPECT_EQ(node["czh"]["dt1"]
.

get<double>(),

1.0000000000000002);
EXPECT_EQ(node["czh"]["dt2"]
.

get<double>(),

2.2250738585072009e-308);
EXPECT_EQ(node["czh"]["dt3"]
.

get<double>(),

-2.2250738585072009e-308);
EXPECT_EQ(node["czh"]["dt4"]
.

get<double>(),

2.2250738585072014e-308);
EXPECT_EQ(node["czh"]["dt5"]
.

get<double>(),

-2.2250738585072014e-308);
EXPECT_EQ(node["czh"]["dt6"]
.

get<double>(),

1.7976931348623157e+308);
EXPECT_EQ(node["czh"]["dt7"]
.

get<double>(),

-1.7976931348623157e+308);
EXPECT_EQ(utils::dtoa(node["czh"]["dt8"].get<double>()),
"0.0");
EXPECT_EQ(utils::dtoa(node["czh"]["dt9"].get<double>()),
"-0.0");
